...
int Director::check(Conveyor* product) {
	if (product->machine == "¬оенный") { return 2; }
	else if (product->machine == "ѕассажирский") { return 1; }
	else if (product->machine == " вадрокоптер") { return 3; }
	else if (product->machine == "¬ертолет") { return 4; }
	else return -1;
}
